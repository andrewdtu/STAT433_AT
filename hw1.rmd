...
flights_3 = flights_2 %>%
  ...
  ungroup()
ggplot(flights_3, aes(y=daily_cancelled))+
  geom_point(aes(x = mean_arr_delay, color = 'blue'))+
  geom_point(aes(x = mean_dep_delay, color = 'red'))+
  labs(x = "Mean delay (minutes per day)", y = "Flights cancelled (per day)")+
